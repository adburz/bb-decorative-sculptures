...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: "heroEyebrow",
      title: "Nadtytuł (eyebrow)",
      type: "localizedString",
      group: "home",
      description: "Mały tekst nad głównym tytułem. Np. 'RZEŹBA — PRACOWNIA KATOWICE'.",
    }),
    defineField({
      name: "heroTitle",
      title: "Tytuł bannera",
      type: "localizedString",
      group: "home",
      description: "Główny nagłówek H1 na stronie startowej.",
    }),
    defineField({
      name: "heroLead",
      title: "Lead (opis pod tytułem)",
      type: "localizedString",
      group: "home",
      description: "Jedno–dwa zdania pod tytułem bannera.",
    }),
    defineField({
      name: "heroCtaLabel",
      ...
      type: "localizedString",
      group: "home",
      description: "Etykieta przycisku prowadzącego do galerii rzeźb. Np. 'ZOBACZ KOLEKCJĘ'.",
    }),
    defineField({
      name: "defaultOgImage",
